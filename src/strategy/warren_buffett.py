...
def warren_buffett_agent(ticker: str, end_date: str):
    ...
    total_score = fundamental_analysis["score"] + consistency_analysis["score"] + moat_analysis["score"] + \
                  mgmt_analysis["score"]
    ...
    prompt = """You are a Warren Buffett AI agent. Decide on investment signals based on Warren Buffett's principles:
